...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/AIMJSONModelNetworking-iOS'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Tzoani' => 'darksky_ddd@hotmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/AIMJSONModelNetworking-iOS.git', :tag => s.version.to_s }
